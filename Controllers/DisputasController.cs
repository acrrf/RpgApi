        ...
        public async Task<IActionResult> DisputaEmgrupoAsync(Disputa d)
        {
            try
            {
                ...
                while (qtdPersonagensVivos > 1)
                {
                    ...
                    //Sorteia entre 0 e 1: 0 é umataque com arma e 1 é um ataque com habilidades.
                    ...
                    if (ataqueUsaArma && atacante.Arma != null)
                    {
                        ...
                        d.Narracao += resultado;//Concatena o resultado com as narrções existentes.
                    ...
                    if (qtdPersonagensVivos == 1)//Havendo só um personagem vivo, existe um CAMPEÃO!
                    {
                        ...
                        d.Narracao += resultadoFinal;//Concatena o resultado finsl com as demais narrações.
